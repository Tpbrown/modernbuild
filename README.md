...
7. Force a resolve of third party (binary) dependencies.  _Please_ consider committing these into your source tree instead of fetching.
...
BUILD FAILED: //third_party:guice-jar failed with exit code -1:
curl
...
$vim third_party/BUCK  # Fix the SHA1 errors
$buck test
```
